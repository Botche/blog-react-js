...
The application uses react version 18 and json-server as API.
...
The application gives the possibility to create, edit, delete and view blogs. Also, the user can create categories for the blogs. The blogs can be viewed by different layouts (list and grid).
